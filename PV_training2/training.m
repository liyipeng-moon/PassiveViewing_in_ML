...
editable('reward_max_interval','reward_min_interval','reward_step', 'reward_duration', 'fixation_window', 'max_break_time','fix_dot_size','img_size')
...
kc2 = KeyChecker(mouse_);
kc2.KeyNum = 1;  % 1st keycode
my = MyAdapter(kc2);
my.endtime = Totaltime;
